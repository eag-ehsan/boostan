...
var level = {
        ...
        width: 0,       // Width, gets calculated
        height: 0,      // Height, gets calculated
        columns: 15*2,    // Number of tile columns
        rows: 15*2,       // Number of tile rows
        tilewidth: 30,  // Visual width of a tile
        tileheight: 30, // Visual height of a tile
        rowheight: 34/2,  // Height of a row
        radius: 20/2,     // Bubble collision radius
        tiles: []       // The two-dimensional tile array
    };
var level2 = {
        x: 4,           // X position
        ...
        width: 0,       // Width, gets calculated
        height: 0,      // Height, gets calculated
        columns: 15*4,    // Number of tile columns
        rows: 14*4,       // Number of tile rows
        tilewidth: 40/4,  // Visual width of a tile
        tileheight: 40/4, // Visual height of a tile
        rowheight: 34/4,  // Height of a row
        radius: 20/4,     // Bubble collision radius
        tiles: []       // The two-dimensional tile array
    };
    ...
    function render() {
        ...
        context.fillStyle = "#c6efe3";
        context.fillRect(level.x - 4, level.y - 4, level.width + 8, level.height + 4 - yoffset);
        var background = new Image();
		background.src = "images/LOGO2.png";
		context.drawImage(background,50,100);

		// Render tiles
        renderTiles();

        // Draw level bottom
        context.fillStyle = "#3e8e77";
    ...
    function drawFrame() {
        ...
        context.fillStyle = "#ffffff";
        context.font = "24px Verdana";
        context.fillText("Try to set your best record", 10, 37);
